    ...
    <section id="about">
        ...
        <div class="container">
            ...
            <div class="about-wrapper">
                ...
                <div class="content">
                    <h5 class="title mb-3">GARNET IDENTITY FEDERATION (GIF)</h5>
                    <!-- row -->
                    <div class="row">
                        <div class="col">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="sub1.jpg" class="w-100" alt="About Us">
                    </div>
                </div>
                <div class="col-md-5">
...
<p>Organisations that are not subscribed to GARNET membership and have a desire to join the GIF as a SP only, can join under non-member terms. Please contact the GARNET Secretariat for more details.</p>
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="sub2.jpg" class="w-100" alt="About Us">
                    </div>                      
                </div>
            </div><!-- End of Row -->           
        </div><!-- End of Container-->      
        ...
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="sub3.jpg" class="w-100" alt="About us">
                    </div>
                </div>
                <div class="col-md-5">
    ...
    <section id="con" class="has-bg-img text-center text-light height-auto" style="background-image: url(con1.jpg)">
