...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Page Navbar -->
    <nav id="scrollspy" class="navbar page-navbar navbar-light navbar-expand-md fixed-top" data-spy="affix" data-offset-top="20" style="background-color: #fff;">
        <div class="container">
   ...
   <div class="about-wrapper">
                <div class="after"><h1>About GIF</h1></div>
                <div class="content">
