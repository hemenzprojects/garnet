                ...
                <div class="content">
                    ...
                    <h5 class="title mb-3">List of identity providers</h5>
                        ...
                        <h5 class="title mb-3">Service Providers under GIF</h5>
                         ...
                         <ul>
                            <li>University of Ghana (UG)<br></li>
                            <li>Kwame Nkrumah University of Science and Technology (KNUST)</li>
        
                            <li> Ghanaian Academic and Research Network (GARNET)<br><p>Type: Identity Provider <br>Organisation: GARNET <br>Contact Info: Support or Technical</p> </li>
                            <li>Contact Info: Support or Technical</li>
                         </ul>
                    </div>
